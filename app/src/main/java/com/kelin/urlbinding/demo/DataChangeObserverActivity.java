...
public class DataChangeObserverActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseFragment baseFragment = DataChangeObserverFragment.newInstance(mUrl, R.layout.fragment_event_binding_list);
